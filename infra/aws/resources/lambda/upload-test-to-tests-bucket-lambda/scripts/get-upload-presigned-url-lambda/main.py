...
def get_presigned_url_to_upload_to_s3(student_id: str, class_id: str, test_id: str) -> str:
    EXPIRY_TIME = 300
...
def lambda_handler(event, context):
    ...
    try:
        presigned_url = get_presigned_url_to_upload_to_s3(student_id, class_id, test_id)
    except Exception:
